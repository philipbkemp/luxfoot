...
function drawChart(club,colour="red") {
	...
	loadSeason("1938-39",["SDUD","USDD","SPOR","JESH","PRON","ULUX","CROD","NSCH","FOLA","AVBG"],["RBDF","ASDF","CPET","RPDN","STET","RBPF","YBDK","ADUD","ARIS","BBML"],["JWAS","RROD","SCBT","URUM","CSOB","AREM","ETZE","GOLD","MANC","USND"],["EGWM|BLVL","CGRV|ASCH","DARE|UBSH","UMRT|KOPS","ASLX|SWFT","VICR|JKYL","PROG|CSHL","UNAS|UESH","WALF|LLMP","TSVG|TRIM"],["RUPL|SPST|MAMR","OVND|HESH|SBRT","JGIL|MOND|RBAS","MARM|OYMP|ASTN","MINL|HOBS|MDLB","AWDG|JKGB|RSML","FRTA|ESHW|JUNG","UWLD|HRTB|HAMM","DRZV|SAND"]);
	loadSeason("1939-40",["SDUD","USDD","PRON","NSCH","SPOR","ULUX","RBDF","CROD","JESH","ASDF"],["CPET","FOLA","RROD","AVBG","RBPF","JWAS","RPDN","YBDK","STET","SCBT"],["ADUD","ARIS","URUM","AREM","EGWM","CSOB","ASCH","BBML","BLVL","CGRV"],["USND|JKYL","ETZE|UBSH","DARE|MANC","PROG|KOPS","ASLX|CSHL","RUPL|MAMR","UMRT|SWFT","OVND|HESH","VICR|SPST","GOLD|SBRT"],["JGIL|UESH|TRIM","MINL|RSML|RBAS","FRTA|OYMP|LLMP","JUNG|UNAS|JBIW","WALF|MOND|HAMM","MARM|HOBS|MDLB","ASTN|ESHW|SAND","AWDG|JKGB|RIEF"]);
	loadSeason("1940-41",['NULL'],['NULL'],['NULL'],['NULL'],['NULL']);
	loadSeason("1941-42",['NULL'],['NULL'],['NULL'],['NULL'],['NULL']);
	loadSeason("1942-43",['NULL'],['NULL'],['NULL'],['NULL'],['NULL']);
	loadSeason("1943-44",['NULL'],['NULL'],['NULL'],['NULL'],['NULL']);
	loadSeason("1944-45",['NULL'],['NULL'],['NULL'],['NULL'],['NULL']);
	loadSeason("1945-46",["SDUD","USDD","PRON","RBDF","SPOR","CROD","NSCH","ULUX","FOLA","CPET"],["JESH","RROD","URUM","RPDN","RBPF","ADUD","AVBG","ASDF","JWAS","ARIS"],["CSOB","STET","AREM","SCBT","YBDK","UBSH","EGWM","USND","JKYL","ETZE"],["ASCH|PROG","BLVL|ASLX","UESH|UMRT","SWFT|CGRV","RSML|BBML","TRIM|MINL","CSHL|MANC","KOPS|JGIL","MAMR|RUPL","RBAS|DARE"],["SBRT|MDLB|WALF|CLVX","UNAS|BWIT|JUNG|TSVG","SPST|HAMM|VICR|GOLD","OYMP|JBIW|MARM|OVND","JSKO|KWRM|FRTA|AWDG","HOBS|ESHW|ASTN","YBSW|MOND|SAND"]);
	loadSeason("1946-47",["SDUD","USDD","FOLA","ULUX","NSCH","RBDF","SPOR","PRON","JESH","RROD","CROD","CPET"],["RBPF","SCBT","STET","ADUD","URUM","CSOB","AREM","AVBG","JWAS","RPDN","ASDF","ARIS"],["CGRV|YBDK","JKYL|PROG","BLVL|BBML","ASCH|TRIG","EGWM|USND","SWFT|MANC","UBSH|RSML","UMRT|ETZE","UESH|MINL","CSHL|ASLX"],["CLVX|BWIT","MARM|MAMR","DARE|MDLB","RUPL|UNAS","JUNG|JBIW","WALF|KOPS","VICR|SPST","GOLD|RBAS","TSVG|SBRT","JGIL|HAMM"],["JWIL|AWDG|ATBS|OYMP|FRTA|KWRM","KNAP|JSCH|JUSE|JSKO|LRNZ|GRIV","OVND|SURA|YBSW|ASTN|ARBD|RLND","WWMP|MRTZ|PRTZ|HOBS|OBCN|SAND","KPWW|DAHL|LARD|KHLN|OYCW|BOUS","SBEL|SURM|SRED|ESHW|SYRA|MUNS","RLCN|BBEE|FOLS|MOND|HOST|FCNC","EWLZ|JGOS|MONF|LUNA|JFLX","HUPP|EVER|HAGN","FELL"]);
	loadSeason("1947-48",["SDUD","ULUX","RBDF","PRON","USDD","NSCH","FOLA","SPOR","STET","JESH","SCBT","RBPF"],["RROD","CPET","CSOB","URUM","JKYL","CROD","ADUD","CGRV","AVBG","YBDK","PROG","AREM"],["EGWM|RPDN","JWAS|RSML","UBSH|MARM","TRIG|ARIS","ASCH|USND","BWIT|SWFT","BLVL|BBML","ASDF|MANC","MAMR|CLVX","MDLB|DARE"],["UESH|ETZE","KOPS|AWDG","UNAS|WALF","JBIW|RUPL","UMRT|CSHL","KWRM|MINL","JSKO|KNAP","OYMP|FRTA","JUNG|ATBS","ASLX|JSCH"],["WWMP|GOLD|ASTN|ESHW|RBAS|JUSE","TSVG|MRTZ|VICR|SPST|SAND|LARD","GSWW|SURA|JGIL|HAMM|RLND|PRTZ","SBEL|DAHL|ARBD|JHTC|BOUS|SRED","RLCN|JGOS|OVND|KHLN|GRIV|YBSW","HUPP|FCBB|LRNZ|SNEM|MUNS|SMOB","AHOS|UFLN|OYCW|SBRT|FCNC|FOLS","HOSC|RHDS|OBCN|HAGN|HOST|BVAT","SURM|LUNA|JFLX|MONF","BBEE|HOBS|SYRA|EVER","MOND|FELL"]);
	loadSeason("1948-49",["SPOR","FOLA","SDUD","NSCH","PRON","RBDF","ULUX","USDD","STET","CSOB","RROD","CPET"],["JESH","URUM","CGRV","RSML","SCBT","JKYL","CROD","RBPF","ADUD","JWAS","EGWM","RPDN"],["AVBG|PROG","YBDK|BLVL","ARIS|AREM","USND|UBSH","TRIG|ASCH","MARM|UNAS","BBML|BWIT","ETZE|UESH","WALF|KOPS","AWDG|SWFT"],["ASDF|MINL|UMRT","MDLB|ASTN|KWRM","RBAS|JSCH|DARE","MAMR|TSVG|VICR","SPST|CLVX|MANC","CSHL|WWMP|JBIW","ASLX|GOLD|RUPL","OYMP|MRTZ|SAND","JSKO|ATBS|FRTA","ESHW|KNAP|JUNG"],["LUNA|ARBD|SMOB|RLCN|SURA|LRNZ","SNEM|OBCN|LARD|HUPP|DONC|MUNS","HAMM|BBEE|BSSW|SBEL|JGOS|SYRA","TLMD|OYCW|SRED|AHOS|RHDS|GRIV","KHLN|OVND|PRTZ|HOSC|HARL|HOST","JHTC|REIS|EVER|TWTC|JFLX","SBRT|JGIL|JUSE|DAHL|FCNC","MOND|BWMD|UFLN|GRAU","HAGN|SURM|MONF","HOBS|BAST|BVAT"]);
	loadSeason("1949-50",["SDUD","NSCH","SPOR","RBDF","ULUX","JESH","USDD","PRON","STET","FOLA","URUM","CGRV"],["RROD","CROD","YBDK","CPET","RSML","CSOB","AVBG","RBPF","PROG","BLVL","SCBT","JKYL"],["EGWM|ADUD","RPDN|JWAS","MARM|ASDF","USND|UBSH","DARE|AREM","ARIS|RBAS","ASTN|MAMR","BBML|MDLB","BWIT|ASCH","MINL|UNAS","TRIG|KWRM","JSCH|UMRT"],["ETZE|JBIW|UESH","WWMP|RUPL|LUNA","TSVG|SAND|SWFT","AWDG|WALF|CSHL","CLVX|KOPS|SNEM","MRTZ|LRNZ|SPST","GOLD|ARBD|MANC","RLCN|VICR|OYMP","BBEE|ASLX|SMOB","MUNS"],["SURA|OVND|HAMM|TLMD|LARD|FRTA","HARL|REIS|SYRA|JHTC|ATBS|OYCW","DONC|AHOS|SBRT|KHLN|BSSW|OBCN","UFLN|JGIL|USMM|JSKO|PRTZ|JUNG","HUPP|HOSC|FCNC|MOND|JUSE|BWMD","DAHL|BAST|BOUS|HOBS|SRED|GRAU","RHDS|SURM|JFLX|HAGN|EVER|HOST","JGOS|JHSD|JOSP","BVAT","MONF"]);
	loadSeason("1950-51",["JESH","NSCH","RBDF","SDUD","SPOR","STET","ULUX","PRON","RROD","CROD","USDD","YBDK"],["FOLA","AVBG","URUM","RSML","JWAS","RPDN","CGRV","ADUD","CSOB","CPET","EGWM","RBPF"],["ASDF|ARIS","BLVL|BBML","ASCH|PROG","SCBT|ETZE","JKYL|USND","MAMR|DARE","UESH|ASTN","AREM|BWIT","UBSH|MARM","RBAS|WWMP","LUNA|JBIW","MDLB|RUPL"],["TLMD|WALF|OVND","UNAS|ARBD|JSCH","HAMM|MINL|AWDG","CSHL|KWRM|CLVX","SWFT|KOPS|TSVG","SNEM|SAND|LARD","SPST|LRNZ|GOLD","OYMP|UMRT|MRTZ","MANC|ASLX|HARL","TRIG|FRTA|RLCN"],["KNAP|VICR|USMM|JHTC|ATBS","AHOS|JGIL|JFLX|HAGN|BVAT","HUPP|OYCW|SYRA|MOND|SRED","DAHL|REIS|FCNC|JSKO|JOSP","RHDS|BWMD|JUNG|KHLN|BSSW","JGOS|OBCN|HOST|SBRT|EVER","TWTC|BAST|BOUS|ESHW|PRTZ","BBEE|GRAU|JHSD|SMOB","UFLN|BDBB|HOBS|JUSE","HOSC|MUNS|MONF"])
	loadSeason("1951-52",["NSCH","SPOR","SDUD","PRON","FOLA","RBDF","JESH","ULUX","STET","RROD"],["RSML|ADUD","CGRV|URUM","YBDK|USDD","PROG|BLVL","JWAS|CROD","AVBG|ASCH","ARIS|CPET","RBPF|CSOB","RPDN|ASDF","BBML|SCBT"],["JKYL|ETZE","TLMD|DARE","RBAS|WALF","UESH|ASTN","UBSH|USND","MAMR|RUPL","AREM|MARM","LUNA|JBIW","BWIT|OVND","MDLB|WWMP"],["CSHL|MINL|AWDG","SWFT|SAND|JSCH","UNAS|HAMM|BVAT","SNEM|KOPS|GOLD","JHTC|KWRM|TSVG","SPST|VICR|JGIL","HAGN|UMRT|LARD","OYMP|ARBD|MRTZ","MOND|LRNZ|CLVX"],["HUPP|FRTA|SYRA|EGWM|SRED","RHDS|BWMD|JUNG|JSKO|ATBS","AHOS|OBCN|BDBB|MANC|BSSW","DAHL|OYCW|HOST|TRIG|JOSP","TWTC|REIS|USMM|ASLX|PRTZ","HARL|BAST|FCNC|SBRT|EVER","UFLN|BOUS|JHSD","MUNS|KHLN","HOBS"]);
	loadSeason("1952-53",["PRON","JESH","SDUD","RBDF","FOLA","ULUX","RSML","NSCH","SPOR","STET","ADUD","RROD"],["CGRV|USDD","RBPF|URUM","PROG|BLVL","WALF|CPET","YBDK|CSOB","AVBG|CROD","JWAS|ASCH","BBML|TLMD","ARIS|JKYL","ETZE|ASDF","RPDN|SCBT","DARE|UESH"],["KOPS|CSHL","MINL|HAMM","MARM|MAMR","ASTN|UNAS","AWDG|RBAS","OVND|SAND","USND|AREM","JBIW|SWFT","RUPL|LUNA","GOLD|BWIT","JSCH|MDLB","BVAT|UBSH"],["ARBD|SNEM","BWMD|EGWM","SRED|JHTC","VICR|JSKO","ATBS|MOND","WWMP|OYMP","TSVG|SPST","JUNG|UMRT","LARD|KWRM","JGIL|LRNZ","RHDS|SYRA","HAGN"],["OYCW|TRIG","PRTZ|SBRT","BSSW|MANC","OBCN|JHSD","REIS|ASLX","FRTA|USMM","BAST|BDBB","TWTC|MUNS","JOSP|KHLN","CLVX|BOUS","AHOS|HOST","UFLN|FCNC"])
	loadSeason("1953-54",["JESH","FOLA","PRON","CGRV","ULUX","SDUD","NSCH","STET","RBDF","RSML","USDD","SPOR"],["RROD|ADUD","PROG|BLVL","JWAS|CROD","RBPF|URUM","BBML|CSOB","AVBG|ASCH","ETZE|HAMM","ARIS|TLMD","WALF|CPET","YBDK|ASDF","KOPS|JKYL","MINL|CSHL"],["RPDN|SCBT","DARE|MAMR","ASTN|EGWM","USND|UNAS","OVND|RBAS","MARM|SAND","GOLD|AREM","ARBD|SWFT","AWDG|LUNA","BWMD|SNEM","RUPL|UESH","JBIW|BWIT"],["JSCH|JHTC","MANC|UMRT","PRTZ|KWRM","SRED|JSKO","BVAT|SBRT","VICR|UBSH","TSVG|LRNZ","JUNG|SPST","BSSW|MOND","OYCW|TRIG","LARD|OYMP","MDLB"],["CLVX|JHSD","JUSE|HOST","FRTA|ASLX","OBCN|HOBS","JOSP|BDBB","BAST|KHLN","UFLN|SYRA","AHOS|USMM","JGIL|MUNS","REIS|HAGN"]);
	loadSeason("1954-55",["SDUD","FOLA","ULUX","NSCH","PRON","RSML","RBDF","ADUD","JESH","RROD","CGRV","STET"],["SPOR|CROD","PROG|URUM","ARIS|BLVL","JWAS|USDD","WALF|ASCH","ETZE|SCBT","RBPF|HAMM","RPDN|CPET","BBML|CSOB","AVBG|TLMD","YBDK|ASDF","DARE|MAMR"],["KOPS|AREM","MINL|RBAS","AWDG|UMRT","ARBD|JKYL","USND|SNEM","MANC|EGWM","OVND|UNAS","BWMD|SAND","JSCH|SWFT","MARM|JHTC","ASTN|CSHL","GOLD|LUNA"],["CLVX|UBSH","TSVG|KWRM","BVAT|SBRT","VICR|BWIT","BSSW|LRNZ","JBIW|TRIG","FRTA|UESH","SRED|JSKO","JUSE|MOND","JUNG|SPST","RUPL|HOST","PRTZ|JHSD"],["JOSP|MDLB","BAST|OYMP","OBCN|KHLN","JGIL|MLSV","OYCW|BDBB","REIS|HAGN","LARD|SYRA","UFLN|ASLX","ATBS|MUNS","TWTC|HOBS","AHOS|ISKA","USMM"]);
