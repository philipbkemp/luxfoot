...
function buildGraph() {
	...
	/*1933-34*/ loadSeason(["SPOR","RBDF","USDD","ULUX","JESH","PRON","NSCH","FOLA"],["RBPF","ARIS","SDUD","ASDF","ADUD","CROD","PROG","URUM"],["CPET","AVBG","BLVL","JWAS","SWFT","RSML","YBDK","SCBT"],["TRIM|CSOB","CSHL|STET","ASLX|AREM","USND|MAMR","ETZE|JKYL","GOLD|CGRV","UBSH|RPDN","SPST|UMRT"],["DARE|RBAS|MANC","VICR|UNAS|EGWM","WWMP|BBML|RROD","MARM|MDLB|JHTC","MINL|UESH|ESHW","KOPS|LUXC|OYMP"]);
	/*1934-35*/ loadSeason(["SPOR","RBDF","JESH","USDD","RBPF","ULUX","ARIS","PRON"],["FOLA","ASDF","NSCH","SDUD","CPET","CROD","ADUD","AVBG"],["BLVL","URUM","TRIM","PROG","CSOB","JWAS","RSML","SWFT"],["EGWM|CSHL","ASLX|STET","MANC|AREM","DARE|RBAS","YBDK|SCBT","USND|MAMR","ETZE|CGRV","GOLD|JKYL"],["MDLB|RROD|RPDN|WALF|GSWW","UESH|JHTC|UNAS|MARM|AWDG","UMRT|MDCG|BBML|JGIL|WWMP","BOUS|SPST|KOPS|MINL|TSVG","VICR|UBSH|SBRT|SCHR|SURA","BECH|OYMP|LUXC|WRMC|AHOS","ESHW|JGOB|JSCV","LAHD"]);
